...
public class Butterfly_Model<T extends Butterfly_Entity> extends EntityModel<T> {
	...
	public Butterfly_Model() {
		...
		lwing.setPos(2, 16, 0);
		lwing.texOffs(0, 18).addBox(0, 0,  1, 4, 1, 4, 0, 0, 0);
		lwing.texOffs(0, 16).addBox(0, 0,  0, 3, 1, 1);
		lwing.texOffs(0, 10).addBox(0, 0, -5, 5, 1, 5);
		rwing = new ModelRenderer(this, 0, 10);
		rwing.setPos(-2, 16, 0);
		rwing.texOffs(0, 18).addBox(-4, 0,  1, 4, 1, 4, true);
		rwing.texOffs(0, 16).addBox(-3, 0,  0, 3, 1, 1, true);
		rwing.texOffs(0, 10).addBox(-5, 0, -5, 5, 1, 5, true);
	}
	...
	public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount,
		...
		rwing.zRot = wingangle;
		// link the two
		lwing.zRot = -1.0F * rwing.zRot;
	}
